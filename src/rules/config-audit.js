/**
 * Configuration security audit — detect insecure config patterns
 * Catches: debug mode, CORS wildcard, TLS/SSL disabled, insecure protocols
 */
...
function isConfigContext(line) {
  // Lines that look like config assignments
